...
var format_Medical_Services_Only_2 = new ol.format.GeoJSON();
var features_Medical_Services_Only_2 = format_Medical_Services_Only_2.readFeatures(json_Medical_Services_Only_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Medical_Services_Only_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Medical_Services_Only_2.addFeatures(features_Medical_Services_Only_2);
var lyr_Medical_Services_Only_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Medical_Services_Only_2, 
                style: style_Medical_Services_Only_2,
                popuplayertitle: "Medical_Services_Only",
                interactive: true,
                title: '<img src="styles/legend/Medical_Services_Only_2.png" /> Medical_Services_Only'
            });
...
lyr_OSMStandard_0.setVisible(true);lyr_Pop_dissolved_1.setVisible(true);lyr_Medical_Services_Only_2.setVisible(true);lyr_Medical_Services_Voronoi_Clipped_3.setVisible(true);
var layersList = [lyr_OSMStandard_0,lyr_Pop_dissolved_1,lyr_Medical_Services_Only_2,lyr_Medical_Services_Voronoi_Clipped_3];
...
lyr_Medical_Services_Only_2.set('fieldAliases', {'LANDMARKID': 'LANDMARKID', 'LANDMARK': 'LANDMARK', 'CATEGORY': 'CATEGORY', 'CIVIC_NO': 'CIVIC_NO', 'STREET': 'STREET', 'OWNERSHIP': 'OWNERSHIP', 'CREATE_DAT': 'CREATE_DAT', 'UPDATE_DAT': 'UPDATE_DAT', 'SOURCE': 'SOURCE', 'SOURCE_DAT': 'SOURCE_DAT', 'SUBCATEGOR': 'SUBCATEGOR', 'STATUS': 'STATUS', 'STATUS_DAT': 'STATUS_DAT', 'MUNICIPAL_': 'MUNICIPAL_', 'COMMON_LOC': 'COMMON_LOC', 'LOCATION_D': 'LOCATION_D', 'ON_CALL': 'ON_CALL', 'DIVISION_R': 'DIVISION_R', 'ASSOCIATED': 'ASSOCIATED', 'CONSTRUCTI': 'CONSTRUCTI', 'MAP_LABEL': 'MAP_LABEL', 'Physicians': 'Physicians', });
...
lyr_Medical_Services_Only_2.set('fieldImages', {'LANDMARKID': 'TextEdit', 'LANDMARK': 'TextEdit', 'CATEGORY': 'TextEdit', 'CIVIC_NO': 'TextEdit', 'STREET': 'TextEdit', 'OWNERSHIP': 'TextEdit', 'CREATE_DAT': 'DateTime', 'UPDATE_DAT': 'DateTime', 'SOURCE': 'TextEdit', 'SOURCE_DAT': 'DateTime', 'SUBCATEGOR': 'TextEdit', 'STATUS': 'TextEdit', 'STATUS_DAT': 'DateTime', 'MUNICIPAL_': 'TextEdit', 'COMMON_LOC': 'TextEdit', 'LOCATION_D': 'TextEdit', 'ON_CALL': 'TextEdit', 'DIVISION_R': 'TextEdit', 'ASSOCIATED': 'TextEdit', 'CONSTRUCTI': 'TextEdit', 'MAP_LABEL': 'TextEdit', 'Physicians': '', });
